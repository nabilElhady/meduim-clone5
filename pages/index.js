...
export default function Home(props) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <Header></Header>
      <div className="flex justify-around items-center bg-yellow-400 border-y border-black py-4 lg:py-0">
      ...
      <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-6">
        {props.posts.map((post) => (
          <Link key={post._id} href={`/post/${post.slug.current}`}>
            <div className=" group cursor-pointer border rounded-lg border-whiteSmoke-300 overflow-hidden">
              {post.mainImage && (
                <img
